...
public class GrenadeLauncher : MonoBehaviour, IRegisterProperty, IWeapon
{
    ...
    {
        GameObject go = new GameObject("Bullet", typeof(Block), typeof(KillableByNonMatchingSubType), typeof(AbsorbData), typeof(AbsorbableByMatchingSubType), typeof(DamageAreaOnKill), typeof(DestroyOnKill), typeof(PauseController));
        ...
        block.GetComponent<DamageAreaOnKill>().explosionEffectPrefab = explosionEffectPrefab;
